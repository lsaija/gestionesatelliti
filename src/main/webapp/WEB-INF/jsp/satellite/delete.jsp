			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					     <form:form modelAttribute="delete_satellite_attr" method="post" action="${pageContext.request.contextPath }/satellite/saveDelete" class="row g-3" novalidate="novalidate">
					    	<dl class="row">
